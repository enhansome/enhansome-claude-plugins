...
* [kaggle-skill](https://github.com/shepsci/kaggle-skill) ⭐ 84 | 🐛 0 | 🌐 Python | 📅 2026-07-04 - Complete Kaggle integration — account setup, competition reports, dataset/model downloads, notebook execution, submissions, and badge collection.
...
* [AgentLint](https://github.com/0xmariowu/AgentLint) ⭐ 53 | 🐛 1 | 🌐 Shell | 📅 2026-07-24 - Lint your repo for AI agent compatibility. 33 evidence-backed checks across 5 dimensions. Claude Code plugin.
...
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,492 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-01 - Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage. Includes Claude Code [skill](https://github.com/mnfst/manifest/blob/main/skills/manifest/SKILL.md) ⭐ 7,492 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-01 for guided setup. Self-hosted, OTLP ingestion, 28+ LLM models. ([Website](https://manifest.build))
...
* [context-mode](https://github.com/mksglu/claude-context-mode) ⭐ 20,294 | 🐛 200 | 🌐 TypeScript | 📅 2026-09-01 - Process large outputs in sandboxed subprocesses, keeping only summaries in the context window. 98% context savings across 21 benchmarked scenarios.
...
* [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) ⭐ 74,219 | 🐛 1,378 | 🌐 Python | 📅 2026-08-10 - More skills and resources
