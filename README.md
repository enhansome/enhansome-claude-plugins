...
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,540 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-22 - Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage. Includes Claude Code [skill](https://github.com/mnfst/manifest/blob/main/skills/manifest/SKILL.md) ⭐ 7,540 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-22 for guided setup. Self-hosted, OTLP ingestion, 28+ LLM models. ([Website](https://manifest.build))
...
* [security-sweep](https://github.com/Onome-AJ/security-sweep-plugin) ⭐ 7 | 🐛 0 | 📅 2026-04-05 - Comprehensive security scanner covering OWASP Top 10 (2025), Mobile Top 10 (2024), and LLM Top 10 (2025). Scans for hardcoded secrets, injection flaws, auth issues, misconfigurations, and AI-specific vulnerabilities.
...
* [context-mode](https://github.com/mksglu/claude-context-mode) ⭐ 23,948 | 🐛 274 | 🌐 TypeScript | 📅 2026-09-22 - Process large outputs in sandboxed subprocesses, keeping only summaries in the context window. 98% context savings across 21 benchmarked scenarios.
...
* [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) ⭐ 75,491 | 🐛 1,503 | 🌐 Python | 📅 2026-09-18 - More skills and resources
